...
_recipes_pil_prescript(['McIdasImagePlugin', 'FpxImagePlugin', 'CurImagePlugin', 'FliImagePlugin', 'XpmImagePlugin', 'ImImagePlugin', 'Hdf5StubImagePlugin', 'BufrStubImagePlugin', 'XbmImagePlugin', 'TgaImagePlugin', 'BmpImagePlugin', 'SgiImagePlugin', 'PalmImagePlugin', 'TiffImagePlugin', 'PsdImagePlugin', 'PixarImagePlugin', 'MicImagePlugin', 'PcdImagePlugin', 'MpoImagePlugin', 'GribStubImagePlugin', 'PcxImagePlugin', 'GifImagePlugin', 'PpmImagePlugin', 'Jpeg2KImagePlugin', 'WebPImagePlugin', 'MpegImagePlugin', 'BlpImagePlugin', 'ImtImagePlugin', 'WmfImagePlugin', 'FtexImagePlugin', 'XVThumbImagePlugin', 'IcoImagePlugin', 'JpegImagePlugin', 'MspImagePlugin', 'IptcImagePlugin', 'DdsImagePlugin', 'DcxImagePlugin', 'SpiderImagePlugin', 'IcnsImagePlugin', 'SunImagePlugin', 'FitsStubImagePlugin', 'EpsImagePlugin', 'PngImagePlugin', 'PdfImagePlugin', 'GbrImagePlugin'])
...
DEFAULT_SCRIPT='catanDiceRoller.py'
SCRIPT_MAP={}
_run()
